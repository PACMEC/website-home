 ...
 * @version    1.0.0
 */
namespace PACMEC\Users
{
  class User extends \PACMEC\System\BaseRecords
  {
    ...
    public function __construct($opts=null)
    {
      Parent::__construct();
      $opts = (object) $opts;
      if(isset($opts->id)) $this->get_by_id($opts->id);
      if(isset($opts->user_id)) $this->get_by_id($opts->user_id);
      elseif(isset($opts->email)) $this->get_by('email', $opts->email);
